...
export class Backend implements backendInterface {
    ...
    async getSignals(arg0: string, arg1: string): Promise<Array<Signal>> {
        if (this.processError) {
            try {
    ...
    async postSignal(arg0: string, arg1: string, arg2: string, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.postSignal(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
